...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch startStopSwitch = (Switch) findViewById(R.id.startStopSwitch);//declared the switch here pointing to id onOffSwitch
        myFrequency = (TextView) findViewById(R.id.myFrequency);
        ...
        {
            @Override
            public void onProgressChanged(SeekBar volume, int progress,
                                          boolean fromUser)
            {
                volumeValue = progress;
                sendFloatPD("slider1", volumeValue);
            }
            @Override
